...
copy /y "%~dp0..\..\Skins\skin.skin" "%systemdrive%\Program Files\Open-Shell\Skins" 
copy /y "%~dp0..\..\Skins\skin.skin7" "%systemdrive%\Program Files\Open-Shell\Skins" 
...
:: Removed destructive renaming of system files.
:: OpenShell handles the start menu interception without needing to delete the native host.
exit /b 