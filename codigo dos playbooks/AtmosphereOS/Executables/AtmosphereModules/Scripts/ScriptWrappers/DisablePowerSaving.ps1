...
# Duplicate Ultimate Performance power scheme, customize it and make it the Atmosphere power scheme
...
powercfg /changename scheme_current "Atmosphere Power Scheme" "Power scheme optimized for optimal latency and performance."
...
& "$windir\AtmosphereModules\Scripts\toggleDev.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
