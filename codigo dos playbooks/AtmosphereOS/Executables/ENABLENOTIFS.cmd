...
for %%a in (
	...
	call "%windir%\AtmosphereModules\Scripts\settingsPages.cmd" /unhide %%~a /silent
)

:: Enable services
call "%windir%\AtmosphereModules\Scripts\settingsPages.cmd" /unhide %%~a /silentSvc.cmd" "WpnUserService" 2
