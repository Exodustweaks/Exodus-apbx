...
call "%windir%\AtmosphereModules\Scripts\setSvc.cmd" Spooler 4
call "%windir%\AtmosphereModules\Scripts\setSvc.cmd" PrintWorkFlowUserSvc 4

call "%windir%\AtmosphereModules\Scripts\settingsPages.cmd" /hide printers
