...
if %errorlevel%==1 (
	call "%windir%\AtmosphereDesktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd" /silent
) else (
	call "%windir%\AtmosphereDesktop\3. General Configuration\Hibernation\Enable Hibernation.cmd" /silent
)
